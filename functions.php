...
function front_page_scripts() {
	...
	wp_enqueue_style( 'unoSlider-css', get_template_directory_uri() . '/css/unoSlider.css' );
	...
	wp_enqueue_script( 'unoSlider-js', get_template_directory_uri() . '/js/vendor/unoSlider.min.js', array('jquery'), '1.0.4', true );
